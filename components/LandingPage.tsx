            ...
            <div className="min-h-screen bg-gradient-to-br from-background to-muted flex items-center justify-center p-4">
                <div className="max-w-md w-full">
                    <div className="text-center mb-8 flex justify-center">
                        <img src="/ELDDADY2_transprnt_Y2.svg" alt="Elddady Logo" className="h-40 w-auto object-contain drop-shadow-lg mb-2" />
                    </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-background to-muted flex items-center justify-center p-4">
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-8 flex flex-col items-center">
                    <img src="/ELDDADY2_transprnt_Y2.svg" alt="Elddady Logo" className="h-48 w-auto object-contain drop-shadow-lg mb-4" />
